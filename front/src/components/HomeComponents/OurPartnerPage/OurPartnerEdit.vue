            ...
            <v-row class="ml-5 mr-5">
                ...
                <v-col cols="12" md="7">
                    <v-card>
                        ...
                        <v-card-text>
                            <v-text-field label="Name" :rules="titleRules" v-model="item.partner_name"
...
export default {
    ...
    methods: {
        ...
        async fetchItemById() {
            ...
            try {
                const response = await axios.get(`http://localhost:3000/ourpartner/view/${id}`);
        ...
        async updateItem() {
            ...
            try {
                ...
                const response = await axios.put(`http://localhost:3000/ourpartner/update/${id}`, formData, {
                    headers: {
