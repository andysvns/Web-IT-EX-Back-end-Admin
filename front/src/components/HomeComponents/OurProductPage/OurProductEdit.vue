                ...
                <v-col cols="12" md="5">
                    <v-card>
                        ...
                        <v-card-text>
                            ...
                            <v-img :src="displayedImageUrl || item.img || require('@/assets/default.png')"
                ...
                <v-col cols="12" md="7">
                    <v-card>
                        ...
                        <v-card-text>
                            ...
                            <v-textarea label="Description" :rules="descRules" v-model="item.desc" rows="10"
                                outlined></v-textarea>
                        </v-card-text>
                    </v-card>
                </v-col>
...
export default {
    ...
    methods: {
        ...
        async fetchItemById() {
            ...
            try {
                const response = await axios.get(`http://localhost:3000/ourproduct/view/${id}`);
        ...
        async updateItem() {
            ...
            try {
                ...
                const response = await axios.put(`http://localhost:3000/ourproduct/update/${id}`, formData, {
                    headers: {
