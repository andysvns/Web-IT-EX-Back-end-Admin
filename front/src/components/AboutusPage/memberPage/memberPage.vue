      ...
      >
        <template v-slot:item="{ item, index }">
          <tr>
            ...
            <td class="title-td">{{ item.mem_name }}</td>
            <td class="title-td">{{ item.mem_age }}</td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Name", value: "mem_name", align: "center" },
        { text: "age", value: "mem_age", align: "center" },
        { text: "Position", value: "mem_position", align: "center" },
        { text: "Address", value: "mem_address", align: "center" },
    ...
    async deleteItem() {
      ...
      try {
        const response = await axios.put(
          `http://localhost:3000/api/member/del/${this.itemToDelete.team_mem_id}`
        );
